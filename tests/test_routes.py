...
class TestAccountService(TestCase):
    ...
    def test_read_an_invalid_account(self):
        """It should check invalid Read response"""
        account_id = 0 #invalid id 
        resp = self.client.get(
    ...
    def test_update_invalid_account(self):
        """It should check invalid  Account Update"""
        account_id = 0
        resp = self.client.put(f"{BASE_URL}/{account_id}", content_type="application/json")
        self.assertEqual(resp.status_code, status.HTTP_404_NOT_FOUND)
